                ...
                <div className="col-9">
                    ...
                    <div className="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <ul className="list-group">
                            <li className="list-group-item">Solicitud 001</li>
                            <li className="list-group-item">Solicitud 002</li>
                            <li className="list-group-item">Solicitud 003</li>
                            <li className="list-group-item">Solicitud 004</li>
                            <li className="list-group-item">Solicitud 005</li>
                        </ul>
                    </div>
    </div>
  </div>
